...
you are supposed to create a function called getFastPosts that 
fetches posts from these endpoints simultaneously (concurrently)
...
function getFast(post) {
  const promises = posts.map((url) => getFastPosts(url));
